...
type NotificationType = 'announcement_created' | 'message_received' | 'payment_success' | 'payment_failed' | 'default';

function generateEmailContent(notification: { type: string; title: string; message: string; profiles?: { full_name?: string; email?: string } }) {
