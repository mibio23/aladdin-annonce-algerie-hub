...
DROP POLICY IF EXISTS "Authenticated users can create templates" ON public.notification_templates;
DROP POLICY IF EXISTS "Users can update their own templates" ON public.notification_templates;
DROP POLICY IF EXISTS "Users can delete their own templates" ON public.notification_templates;
