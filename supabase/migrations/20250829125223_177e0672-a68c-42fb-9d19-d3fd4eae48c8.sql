-- Insertion d'annonces de test pour tester la recherche avancée (sans user_id)
...
BEGIN
  ...
  select_list := 'gen_random_uuid(), NULL, cat.id, data.title, data.description, data.price';
