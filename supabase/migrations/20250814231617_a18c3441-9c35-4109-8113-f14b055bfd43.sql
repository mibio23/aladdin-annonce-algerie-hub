...
DROP POLICY IF EXISTS "System only write on popular keywords" ON public.popular_keywords;
...
DROP POLICY IF EXISTS "Only creators can read templates" ON public.notification_templates;
...
DROP POLICY IF EXISTS "Only creators can manage banners" ON public.advertising_banners;
