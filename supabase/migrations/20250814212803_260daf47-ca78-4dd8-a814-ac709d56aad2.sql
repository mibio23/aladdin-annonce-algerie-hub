...
CREATE INDEX IF NOT EXISTS idx_bookings_announcement_id ON public.bookings(announcement_id);
...
DROP POLICY IF EXISTS "Users can upload their own booking documents" ON storage.objects;
DROP POLICY IF EXISTS "Users can view their own booking documents" ON storage.objects;
DROP POLICY IF EXISTS "Users can update their own booking documents" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete their own booking documents" ON storage.objects;
