...
async function testInsertionNumeric() {
    console.log('🧪 TEST AVEC ID NUMÉRIQUE\n');
    ...
    try {
        ...
        if (error) {
            ...
            // Essayer sans certaines colonnes problématiques
            ...
            if (error2) {
                console.error('❌ Erreur minimale:', error2.message);
            } else {
...
testInsertionNumeric().then(success => {
    console.log(success ? '\n✅ Test réussi !' : '\n❌ Test échoué');
