...
const { informatiqueElectroniqueDe } = require('./src/data/categories/megaMenuStructures/informatiqueElectronique/de.tsx');

async function migrateInformatiqueElectroniqueDE() {
  console.log('🚀 Début migration Informatique & Électronique - Allemand...');
  ...
  try {
    ...
    const mainCategory = {
      name: informatiqueElectroniqueDe.name,
      slug: informatiqueElectroniqueDe.slug,
      language: 'de',
      level: 0,
      icon: 'Laptop',
      is_active: true,
    ...
    for (const subcategory of informatiqueElectroniqueDe.subcategories) {
    ...
    console.log(`\n🎉 Migration Informatique & Électronique DE terminée!`);
...
migrateInformatiqueElectroniqueDE();