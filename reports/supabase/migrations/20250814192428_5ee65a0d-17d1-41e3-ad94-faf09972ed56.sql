...
CREATE INDEX IF NOT EXISTS idx_notifications_type_category ON public.notifications(type, category);
...
CREATE INDEX IF NOT EXISTS idx_notification_delivery_log_channel_status ON public.notification_delivery_log(channel, status);
