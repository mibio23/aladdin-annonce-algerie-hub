...
DROP POLICY IF EXISTS "Users can upload their own announcement images" ON storage.objects;
DROP POLICY IF EXISTS "Users can view announcement images" ON storage.objects;
DROP POLICY IF EXISTS "Users can update their own announcement images" ON storage.objects;
