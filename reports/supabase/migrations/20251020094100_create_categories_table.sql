...
DROP POLICY IF EXISTS "Category images are viewable by everyone" ON category_images;
...
GROUP BY c.id, c.slug, c.icon_name, c.parent_id, c.level, c.sort_order, c.is_active, c.is_featured, c.description, c.created_at, c.updated_at, ct.name, ct.description, ct.meta_title, ct.meta_description, ct.language_code, ci.image_url, ci.alt_text;
