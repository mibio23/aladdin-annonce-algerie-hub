...
DROP POLICY IF EXISTS "Authenticated users can create AI learning data" ON public.ai_learning_data;
...
DROP POLICY IF EXISTS "Authenticated users can read popular keywords" ON public.popular_keywords;
...
DROP POLICY IF EXISTS "Authenticated users can read search suggestions" ON public.search_suggestions;
...
DROP POLICY IF EXISTS "Limited access to real time trends" ON public.real_time_trends;
