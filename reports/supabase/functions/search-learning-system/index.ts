...
async function handleClickEvent(supabase: SupabaseClient, event: LearningEvent) {
...
async function handleConversionEvent(supabase: SupabaseClient, event: LearningEvent) {
...
async function handleCorrectionEvent(supabase: SupabaseClient, event: LearningEvent) {
...
async function handlePatternEvent(supabase: SupabaseClient, event: LearningEvent) {
...
async function updateKeywordSuccessRate(supabase: SupabaseClient, keyword: string, successful: boolean) {
...
async function analyzePatternForSuggestions(supabase: SupabaseClient, searchSequence: string[]) {
...
async function updateSearchSuggestions(supabase: SupabaseClient, _query: string) {
...
async function updateTrendingScores(supabase: SupabaseClient) {
