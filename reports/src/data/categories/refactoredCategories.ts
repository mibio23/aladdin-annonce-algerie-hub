...
import type { CategorySearchOptions } from './types';
export const searchCategories = (options: CategorySearchOptions = {}) => CategoryUtils.searchCategories(refactoredCategories, options);
