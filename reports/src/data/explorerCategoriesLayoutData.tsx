...
const defaultCategoryImages: Record<string, string> = {
  ...
  "gastronomie-produits-terroir": "https://images.unsplash.com/photo-1517022812141-23620dba5c23?auto=format&fit=crop&w=256&q=80",
  "gastronomie-alimentation": "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=256&q=80",
  ...
  "education-loisirs": "https://images.unsplash.com/photo-1519682333058-8f0f3ff98f6c?auto=format&fit=crop&w=256&q=80",
  "animaux-accessoires": "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?auto=format&fit=crop&w=256&q=80",
...
const categoryStyling: Record<string, { bg: string; text: string; hoverBg: string }> = {
  ...
  "gastronomie-alimentation": { bg: "bg-orange-200 dark:bg-orange-700", text: "text-orange-800 dark:text-orange-100", hoverBg: "hover:bg-orange-300 dark:hover:bg-orange-600" },
  ...
  "education-loisirs": { bg: "bg-sky-100 dark:bg-sky-900", text: "text-sky-800 dark:text-sky-200", hoverBg: "hover:bg-sky-200 dark:hover:bg-sky-800" },
  "animaux-accessoires": { bg: "bg-amber-200 dark:bg-amber-700", text: "text-amber-800 dark:text-amber-100", hoverBg: "hover:bg-amber-300 dark:hover:bg-amber-600" },
...
export const otherCategories: ExplorerCategory[] = popularCategories;
