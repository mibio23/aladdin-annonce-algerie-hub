...
const ShopViewPage = React.lazy(() => import("@/pages/ShopDetails"));
...
export const publicRoutes = [
  // Route directe pour les offres de métier (gestion des accès sans préfixe de langue)
  <Route key="offre-metier-direct" path="offre-metier/:id" element={withLayout(JobOfferDetailsPage, true, 'high')} />,
  ...
  <Route key="lang-wrapper" path="/:lang?" element={<LanguageRouteWrapper />}>
    ...
    <Route key="search-vehicles" path="search/vehicles" element={withLayout(VehicleSearchResultsPage, true, 'high')} />
    <Route key="offre-metier" path="offre-metier/:id" element={withLayout(JobOfferDetailsPage, true, 'high')} />
    ...
    <Route key="shop" path="shop/:id" element={withLayout(ShopViewPage)} />
    <Route key="boutique" path="boutique/:id" element={withLayout(ShopViewPage)} />
    <Route key="boutiques" path="boutiques" element={withLayout(Boutiques)} />
    <Route key="boutiques-rubrique" path="boutiques/:rubrique" element={withLayout(Boutiques)} />
...
export const authRoutes = [
  <Route key="lang-wrapper-auth" path="/:lang?" element={<LanguageRouteWrapper />}>
    ...
    <Route key="edit-announcement" path="edit-announcement/:id" element={withLayout(CreateAnnouncementComplete, true, 'high')} />
    <Route key="messages" path="messages" element={withLayout(Messages, true, 'high')} />
    ...
    <Route key="mes-offres-metiers" path="mes-offres-metiers" element={withLayout(MyJobOffers, true, 'high')} />
  </Route>
];
