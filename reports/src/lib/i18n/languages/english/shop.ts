export const shop = {
  ...
  viewShop: {
    ...
    loginRequiredDescription: "Please log in or register to add this shop to your favorites.",
    noReviews: "No reviews yet",
    noReviewsText: "Be the first to leave a review for this shop.",
    loginRequiredVoteTitle: "Login Required",
    loginRequiredVoteDescription: "Please log in to rate this shop.",
    voteRecorded: "Vote Recorded",
    voteRecordedDesc: "You rated this shop {star} stars.",
    voteError: "Error",
    voteErrorDesc: "Unable to record your vote.",
    loginRequiredContactTitle: "Login Required",
    loginRequiredContactDescription: "Please log in to contact this shop."
  },
  
  // Modal de contact
  contactModal: {
    title: "Contact {shopName}",
    description: "Send a message directly to the shop for more information.",
    contactInfo: "Contact Information",
    yourName: "Your Name",
    yourEmail: "Your Email",
    yourMessage: "Your Message",
    messagePlaceholder: "Describe what you're looking for or ask your questions...",
    sendingButton: "Sending...",
    sendButton: "Send Message",
    messageSent: "Message Sent!",
    messageSentText: "Your message has been sent to {shopName}. You will receive a response soon.",
