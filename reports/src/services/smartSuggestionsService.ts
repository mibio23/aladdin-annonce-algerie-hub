...
class SmartSuggestionsService {
  ...
  async generateSpellingSuggestions(_query: string, _language: string): Promise<SmartSuggestion[]> {
  ...
  async generateSuggestions(context: SuggestionContext): Promise<SmartSuggestion[]> {
    const { searchType, originalQuery, appliedFilters: _appliedFilters, language, location } = context;
