...
export class CategoryService {
  ...
  static async getCategoriesForLanguage(_language: Language): Promise<MenuCategory[]> {
    // Cette méthode ne devrait plus être utilisée directement
    // Utilisez plutôt le hook useCategories dans les composants React
    logger.warn('CategoryService.getCategoriesForLanguage is deprecated. Use useCategories hook instead.');
    return [];
  }
  
  // Version synchrone deprecated
  static getCategoriesForLanguageSync(_language: Language): MenuCategory[] {
    logger.warn('CategoryService.getCategoriesForLanguageSync is deprecated. Use useCategories hook instead.');
    return [];
  }
  
  // Précharger les catégories
  static async preloadCategories(_language: Language): Promise<void> {
    logger.warn('CategoryService.preloadCategories is deprecated. Use usePreloadCategories hook instead.');
  }
  
  // Nettoyer le cache
  static clearCache(): void {
    logger.warn('CategoryService.clearCache is deprecated.');
  }
