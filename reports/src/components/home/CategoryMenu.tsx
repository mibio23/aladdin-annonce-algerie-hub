    ...
    <div className="bg-white border rounded-md overflow-hidden">
      ...
      <div className="divide-y">
        {(() => {
          ...
          const localMode = localMenu.find((c) => c.slug === "mode-et-accessoires" || c.slug === "mode-accessoires");
          const modeIndex = withBaby.findIndex((c: any) => c.slug === "mode-et-accessoires" || c.slug === "mode-accessoires");
