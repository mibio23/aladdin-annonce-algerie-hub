...
interface ConversationalSearchProps {
  isOpen?: boolean;
  onClose?: () => void;
  onSearchQuery?: (query: string, filters?: Record<string, unknown>) => void;
...
const ConversationalSearchAI: React.FC<ConversationalSearchProps> = ({
  ...
  }, [isOpen, categoryContext, loadProactiveSuggestions, t, messages.length]);
  ...
  const handleFeedback = async (messageId: string, rating: number) => {
    try {
      ...
      logger.error('Erreur feedback:', error);
    }
  };
