// Script de migration vers Supabase avec correction "lang"
...
// Configuration Supabase depuis votre fichier .env
...
function parseSQLFile(filePath) {
    try {
        ...
        return matches.map(stmt => {
            // Extraire les valeurs - pattern mis à jour pour capturer language
            ...
            if (valuesMatch) {
                ...
                return {
                    ...
                    lang: language  // Renommé de "language" à "lang"
                };
            }
            return null;
        }).filter(Boolean);
...
async function quickVerify() {
    ...
    for (const lang of languages) {
        const { data, error } = await supabase
            ...
            .eq('lang', lang)  // Changé de 'language' à 'lang'
