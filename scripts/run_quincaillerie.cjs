...
const TASKS = [
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=600&h=600&fit=crop&q=80', // Matériel divers (Assorted Tools)
      'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=600&h=600&fit=crop&q=80', // Perceuse (Drill)
      'https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=600&h=600&fit=crop&q=80'  // Vis et Boulons (Screws & Bolts)
    ]
  }
];
