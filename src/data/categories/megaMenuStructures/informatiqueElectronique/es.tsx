  ...
  subcategories: [
    {
      ...
      slug: "ordinateurs-pc",
      subcategories: [
        { id: "pc-de-bureau", name: "PC de escritorio", slug: "pc-de-bureau" },
        { id: "pc-gaming", name: "PC gaming", slug: "pc-gaming" },
        { id: "pc-professionnels", name: "PC profesionales", slug: "pc-professionnels" },
        { id: "mini-pc", name: "Mini PC", slug: "mini-pc" },
        { id: "pc-tout-en-un", name: "PC todo-en-uno", slug: "pc-tout-en-un" },
        { id: "ordinateurs-portables", name: "Ordenadores portátiles", slug: "ordinateurs-portables" },
        ...
        { id: "pc-reconditionnes", name: "PC reacondicionados", slug: "pc-reconditionnes" }
      ]
    },
    {
      id: "smartphones",
      ...
      subcategories: [
        ...
        { id: "telephones-robustes-rugged", name: "Teléfonos robustos (rugged)", slug: "telephones-robustes-rugged" },
    ...
    },
    {
      ...
      name: "Tablets & Dispositivos Móviles",
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "vitres-protections-ecran", name: "Protectores de pantalla", slug: "vitres-protections-ecran" },
        { id: "supports-telephones", name: "Soportes para teléfonos", slug: "supports-telephones" },
        ...
        { id: "anneaux-grips", name: "Anillos y agarres", slug: "anneaux-grips" },
        { id: "pochettes-impermeables", name: "Fundas impermeables", slug: "pochettes-impermeables" }
      ]
    },
    {
      id: "batteries-charge",
      ...
      subcategories: [
        ...
        { id: "adaptateurs-secteur", name: "Adaptadores de corriente", slug: "adaptateurs-secteur" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "casques-sans-fil", name: "Cascos inalámbricos", slug: "casques-sans-fil" },
        ...
        { id: "kits-mains-libres", name: "Manos libres", slug: "kits-mains-libres" },
    ...
    },
    {
      ...
      name: "Piezas & Reparación de Teléfonos",
      ...
      subcategories: [
        ...
        { id: "nappes-circuits", name: "Cables flex y circuitos", slug: "nappes-circuits" },
        { id: "cameras-avant-arriere", name: "Cámaras frontal/trasera", slug: "cameras-avant-arriere" },
        { id: "chassis-coques-arriere", name: "Chasis y carcasas traseras", slug: "chassis-coques-arriere" },
        ...
        { id: "vitres-arriere", name: "Cristales traseros", slug: "vitres-arriere" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "trackers-gps", name: "Localizadores GPS", slug: "trackers-gps" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "antennes-amplificateurs-reseau", name: "Antenas y amplificadores de red", slug: "antennes-amplificateurs-reseau" },
        { id: "repeteurs-gsm", name: "Repetidores GSM", slug: "repeteurs-gsm" },
        { id: "boitiers-wifi-mobiles", name: "Puntos de acceso Wi-Fi móviles", slug: "boitiers-wifi-mobiles" },
        { id: "adaptateurs-reseau-telephone", name: "Adaptadores de red telefónica", slug: "adaptateurs-reseau-telephone" }
      ]
    },
    {
      ...
      subcategories: [
        { id: "antivols-telephone", name: "Antirrobos para teléfono", slug: "antivols-telephone" },
        { id: "etuis-renforces", name: "Fundas reforzadas", slug: "etuis-renforces" },
        { id: "coques-anti-chute", name: "Fundas anticaída", slug: "coques-anti-chute" },
        { id: "protections-etanches-ip68", name: "Protecciones impermeables IP68", slug: "protections-etanches-ip68" },
        { id: "housses-anti-choc", name: "Fundas antichoque", slug: "housses-anti-choc" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "debloquage-desimlockage", name: "Desbloqueo y liberación", slug: "debloquage-desimlockage" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "disques-durs-hdd", name: "Discos duros HDD", slug: "disques-durs-hdd" },
        { id: "alimentation-pc", name: "Fuentes de alimentación", slug: "alimentation-pc" },
        { id: "boitiers-pc", name: "Cajas de PC", slug: "boitiers-pc" },
        { id: "refroidissement-liquide", name: "Refrigeración líquida", slug: "refroidissement-liquide" },
    ...
    },
    {
      ...
      subcategories: [
        { id: "ecrans-moniteurs", name: "Monitores y pantallas", slug: "ecrans-moniteurs" },
        ...
        { id: "tapis-souris", name: "Alfombrillas de ratón", slug: "tapis-souris" },
        { id: "webcams", name: "Webcams", slug: "webcams" },
        { id: "microphones", name: "Micrófonos", slug: "microphones" },
        { id: "enceintes-pc", name: "Altavoces PC", slug: "enceintes-pc" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "imprimantes-jet-encre", name: "Impresoras de inyección", slug: "imprimantes-jet-encre" },
        ...
        { id: "multifonctions", name: "Impresoras multifunción", slug: "multifonctions" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "liseuses", name: "Lectores electrónicos", slug: "liseuses" },
      ...
      subcategories: [
        ...
        { id: "thermostats", name: "Termostatos", slug: "thermostats" },
        {
          ...
          subcategories: [
            ...
            { id: "fuite-eau", name: "Fugas de agua", slug: "fuite-eau" }
          ]
        },
        ...
        { id: "sonnettes-video", name: "Timbres con vídeo", slug: "sonnettes-video" }
      ]
    },
    {
      ...
      subcategories: [
        ...
        { id: "decodeurs-satellites", name: "Decodificadores de satélite", slug: "decodeurs-satellites" },
        { id: "box-tv-multimedia", name: "TV Box y multimedia", slug: "box-tv-multimedia" },
    ...
    },
    {
      ...
      name: "Accesorios Móviles (Electrónica)",
      ...
      subcategories: [
        ...
        { id: "stations-accueil-mobiles", name: "Estaciones de acoplamiento", slug: "stations-accueil-mobiles" }
      ]
    },
    {
      ...
      subcategories: [
        ...
        { id: "baies-serveurs", name: "Racks para servidores", slug: "baies-serveurs" },
        { id: "nas", name: "NAS", slug: "nas" },
        { id: "onduleurs-ups", name: "SAIs (UPS)", slug: "onduleurs-ups" },
    ...
    },
    {
      ...
      name: "Componentes Electrónicos & Herramientas",
      ...
      subcategories: [
        ...
        { id: "cables-connecteurs", name: "Cables y conectores", slug: "cables-connecteurs" },
