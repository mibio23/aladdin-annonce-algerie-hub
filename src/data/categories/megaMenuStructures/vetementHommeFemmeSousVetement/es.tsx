  ...
  subcategories: [
    ...
    },
    {
      ...
      subcategories: [
        ...
        { id: "cravates-noeuds-papillon", name: "Corbatas & pajaritas", slug: "cravates-noeuds-papillon" },
        { id: "chapeaux-casquettes", name: "Sombreros & gorras", slug: "chapeaux-casquettes" },
        { id: "gants-echarpes", name: "Guantes & bufandas", slug: "gants-echarpes" },
        { id: "lunettes-soleil", name: "Gafas de sol", slug: "lunettes-soleil" },
        { id: "montres", name: "Relojes", slug: "montres" },
        { id: "bijoux-homme", name: "Joyas hombre", slug: "bijoux-homme" },
        { id: "portefeuilles", name: "Carteras", slug: "portefeuilles" },
        { id: "porte-cartes", name: "Tarjeteros", slug: "porte-cartes" },
        { id: "sacoches-besaces", name: "Bolsos & bandoleras", slug: "sacoches-besaces" }
      ]
    },
    {
      id: "vetements-femme",
      ...
      subcategories: [
        {
          ...
          slug: "tops-t-shirts",
          subcategories: [
            { id: "basique", name: "Básica", slug: "basique" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        },
        {
          id: "bottes-bottines",
          name: "Botas & botines",
          slug: "bottes-bottines",
          subcategories: [
            { id: "cuir", name: "Cuero", slug: "cuir" },
            { id: "neige", name: "Nieve", slug: "neige" },
            { id: "pluie", name: "Lluvia", slug: "pluie" }
          ]
        },
        {
          id: "sandales-tongs",
          ...
          subcategories: [
            { id: "cuir", name: "Cuero", slug: "cuir" },
            { id: "sport", name: "Deporte", slug: "sport" },
            { id: "plage", name: "Playa", slug: "plage" }
          ]
        },
        { id: "escarpins", name: "Escarpines", slug: "escarpins" },
        { id: "ballerines", name: "Bailarinas", slug: "ballerines" },
        {
          id: "chaussures-de-sport",
          name: "Calzado deportivo",
          slug: "chaussures-de-sport",
          subcategories: [
            { id: "football", name: "Fútbol", slug: "football" },
            { id: "randonnee", name: "Senderismo", slug: "randonnee" },
            { id: "salle", name: "Gimnasio", slug: "salle" }
          ]
        },
        { id: "chaussures-de-travail-securite", name: "Zapatos de trabajo y seguridad", slug: "chaussures-de-travail-securite" },
        { id: "chaussures-orthopediques-femme", name: "Zapatos ortopédicos para mujer", slug: "chaussures-orthopediques-femme" },
        { id: "chaussures-confort-orthopedique", name: "Confort & ortopédicas", slug: "chaussures-confort-orthopedique" },
        { id: "pantoufles-chaussons", name: "Zapatillas de casa", slug: "pantoufles-chaussons" },
        {
          id: "accessoires-chaussures",
          ...
          subcategories: [
            ...
            { id: "entretien", name: "Cuidado", slug: "entretien" }
          ]
        }
      ]
    },
      ...
      subcategories: [
        {
          ...
          slug: "vetements-ete",
          subcategories: [
            { id: "shorts", name: "Pantalones cortos", slug: "shorts" },
            { id: "debardeurs", name: "Camisetas sin mangas", slug: "debardeurs" },
            { id: "robes-legeres", name: "Vestidos ligeros", slug: "robes-legeres" },
            { id: "maillots-de-bain", name: "Trajes de baño", slug: "maillots-de-bain" },
        ...
        },
        {
          ...
          subcategories: [
            { id: "doudounes", name: "Chaquetas de plumas", slug: "doudounes" },
    ...
    {
      id: "marques-chaussures",
      name: "Marcas de zapatos",
      slug: "marques-chaussures",
      subcategories: [
        { id: "nike", name: "Nike", slug: "nike" },
        { id: "adidas", name: "Adidas", slug: "adidas" },
        { id: "puma", name: "Puma", slug: "puma" },
        { id: "new-balance", name: "New Balance", slug: "new-balance" },
        { id: "skechers", name: "Skechers", slug: "skechers" },
        { id: "vans", name: "Vans", slug: "vans" },
        { id: "converse", name: "Converse", slug: "converse" },
        { id: "timberland", name: "Timberland", slug: "timberland" },
        { id: "dr-martens", name: "Dr. Martens", slug: "dr-martens" },
        { id: "clarks", name: "Clarks", slug: "clarks" },
        { id: "geox", name: "Geox", slug: "geox" }
      ]
    }
  ]
};
