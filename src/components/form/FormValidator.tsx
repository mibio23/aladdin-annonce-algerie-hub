  ...
  useEffect(() => {
    ...
    rules.forEach(rule => {
      ...
      if (!rule.validate(value)) {
        ...
        if (rule.field === 'price' && parseFloat(value) > 1000000000) {
          newSuggestions[rule.field] = "Pour les articles de très grande valeur, incluez des photos de haute qualité et des documents officiels";
        }
