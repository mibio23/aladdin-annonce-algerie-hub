...
const DynamicCategorySection = ({ category }: DynamicCategorySectionProps) => {
  ...
  const mappedAnnouncements = announcements.map(a => ({
    ...
    property_type: (a as Record<string, unknown>).property_type as string | undefined,
    surface: (a as Record<string, unknown>).surface as number | undefined,
    rooms: (a as Record<string, unknown>).rooms as number | undefined,
    bedrooms: (a as Record<string, unknown>).bedrooms as number | undefined,
    bathrooms: (a as Record<string, unknown>).bathrooms as number | undefined,
    floor: (a as Record<string, unknown>).floor as number | undefined,
    furnished: (a as Record<string, unknown>).furnished as boolean | undefined,
