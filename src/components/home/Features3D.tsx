      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <motion.div className="flex flex-col items-center" variants={featureItem}>
          <div className="bg-orange-50 p-4 rounded-full mb-4">
            <Icon3D type="cube" color="#F97316" height={100} width={100} />
          </div>
        ...
        <motion.div className="flex flex-col items-center" variants={featureItem}>
          <div className="bg-blue-50 p-4 rounded-full mb-4">
            <Icon3D type="sphere" color="#0EA5E9" height={100} width={100} />
          </div>
        ...
        <motion.div className="flex flex-col items-center" variants={featureItem}>
          <div className="bg-purple-50 p-4 rounded-full mb-4">
            <Icon3D type="cone" color="#8B5CF6" height={100} width={100} />
          </div>
        ...
        <motion.div className="flex flex-col items-center" variants={featureItem}>
          <div className="bg-pink-50 p-4 rounded-full mb-4">
            <Icon3D type="torus" color="#D946EF" height={100} width={100} />
          </div>
