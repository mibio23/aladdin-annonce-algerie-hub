...
interface MainSearchInputProps {
  ...
  handleLocationSelect: (location: { lat: number; lng: number; address: string; wilayaCode?: string }) => void;
...
const MainSearchInput: React.FC<MainSearchInputProps> = ({
  ...
  handleSuggestionSelect: _handleSuggestionSelect,
  handleVoiceResult,
  ...
  return (
    <div className="relative max-w-xl mx-auto">
      ...
      <div className="relative flex items-center gap-1.5">
        ...
        {/* SmartSearchSuggestions removed as per request */}
