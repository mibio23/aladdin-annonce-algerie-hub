...
export const useIntelligentAssistant = () => {
  ...
  const saveHistory = useCallback((history: ChatMessage[]) => {
    try {
  ...
  // Extraire les mots-clés du message (défini tôt car utilisé par generateFallbackResponse)
  ...
  // Générer une réponse de fallback intelligente (défini tôt car utilisé par sendMessage)
  ...
  }, [sessionId, conversationHistory, searchHistory, saveHistory, generateFallbackResponse]);
