export const shop = {
  ...
  viewShop: {
    ...
    loginRequiredDescription: "Veuillez vous connecter ou vous inscrire pour ajouter cette boutique aux favoris.",
    noReviews: "Aucun avis pour le moment",
    noReviewsText: "Soyez le premier à laisser un avis sur cette boutique.",
    loginRequiredVoteTitle: "Connexion requise",
    loginRequiredVoteDescription: "Veuillez vous connecter pour noter cette boutique.",
    voteRecorded: "Vote enregistré",
    voteRecordedDesc: "Vous avez donné {star} étoiles à cette boutique.",
    voteError: "Erreur",
    voteErrorDesc: "Impossible d'enregistrer votre vote.",
    loginRequiredContactTitle: "Connexion requise",
    loginRequiredContactDescription: "Veuillez vous connecter pour contacter cette boutique."
  },
