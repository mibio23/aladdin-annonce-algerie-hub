-- SCRIPT COMPLET : Créer la structure de base + les tables fonctionnelles
...
-- VÉRIFICATION FINALE
SELECT 
    '✅ Table commerces (shops) créée' as status,
    '✅ Colonne compteur d\'abonnés (followers_count) ajoutée' as status,
    '✅ Table favoris professionnels (pro_favorites) créée' as status,
    '✅ Triggers et sécurité configurés' as status;